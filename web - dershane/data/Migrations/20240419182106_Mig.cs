    ...
    public partial class Mig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Blogs", x => x.BlogPost_Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Blogs_BlogPost_Id",
                        column: x => x.BlogPost_Id,
                        principalTable: "Blogs",
                        principalColumn: "BlogPost_Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<int>(type: "int", nullable: false),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PrePhotoURL = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DetailPhotoURL = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PreBio = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DetailBio = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<bool>(type: "bit", nullable: false),
                    Lesson_Id = table.Column<int>(type: "int", nullable: false),
                    City_Id = table.Column<int>(type: "int", nullable: false),
