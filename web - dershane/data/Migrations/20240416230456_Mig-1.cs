    ...
    public partial class Mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Blogs", x => x.Blog_Post_Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Blog_Subscribe_Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Subscribes", x => x.Blog_Subscribe_Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Blogs_Blog_Post_Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CityTown_Id = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Adresses", x => x.Adress_Id);
                    table.ForeignKey(
                        name: "FK_Adresses_Towns_CityTown_Id",
                        column: x => x.CityTown_Id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TCKNO = table.Column<int>(type: "int", nullable: false),
                    Phone = table.Column<int>(type: "int", nullable: false),
                    Hometown_Id = table.Column<int>(type: "int", nullable: false),
                    HometownTown_Id = table.Column<int>(type: "int", nullable: true),
                    Adress_Id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Parents_Adresses_Adress_Id",
                        column: x => x.Adress_Id,
                        principalTable: "Adresses",
                        principalColumn: "Adress_Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Parents_Towns_HometownTown_Id",
                        column: x => x.HometownTown_Id,
                        principalTable: "Towns",
                        principalColumn: "Town_Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teachers_Adresses_Adress_Id",
                        column: x => x.Adress_Id,
                        principalTable: "Adresses",
                        principalColumn: "Adress_Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Teachers_Lessons_Lesson_Id",
                        column: x => x.Lesson_Id,
                        principalTable: "Lessons",
                        principalColumn: "Lesson_Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Teachers_Towns_HometownTown_Id",
                        column: x => x.HometownTown_Id,
                        principalTable: "Towns",
                        principalColumn: "Town_Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Students_Adresses_Adress_Id",
                        column: x => x.Adress_Id,
                        principalTable: "Adresses",
                        principalColumn: "Adress_Id",
                        onDelete: ReferentialAction.Cascade);
                    ...
                    table.ForeignKey(
                        name: "FK_Students_Towns_HometownTown_Id",
                        column: x => x.HometownTown_Id,
                        principalTable: "Towns",
                        principalColumn: "Town_Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Syllabuses", x => x.Syllabus_Id);
                    table.ForeignKey(
                        name: "FK_Syllabuses_Classes_Class_Id",
                        column: x => x.Class_Id,
                        principalTable: "Classes",
                        principalColumn: "Class_Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Syllabuses_Teachers_Teacher_Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Parents_Adress_Id",
                table: "Parents",
                column: "Adress_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Parents_HometownTown_Id",
                table: "Parents",
                column: "HometownTown_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Students_Adress_Id",
                table: "Students",
                column: "Adress_Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_HometownTown_Id",
                table: "Students",
                column: "HometownTown_Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Syllabuses_Class_Id",
                table: "Syllabuses",
                column: "Class_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Syllabuses_Teacher_Id",
                table: "Syllabuses",
                column: "Teacher_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Teachers_Adress_Id",
                table: "Teachers",
                column: "Adress_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Teachers_HometownTown_Id",
                table: "Teachers",
                column: "HometownTown_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Teachers_Lesson_Id",
                table: "Teachers",
                column: "Lesson_Id");
        }
